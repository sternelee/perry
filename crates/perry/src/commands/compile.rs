...
fn emit_harmonyos_arkts_stubs(output_dir: &Path, so_filename: &str) -> Result<()> {
    ...
    // `entry` must match `nm_modname` in crates/perry-runtime/src/ohos_napi.rs.
    // The import specifier uses the `.so` filename, but the bound name on the
    // ArkTS side is a developer choice — we go with `perryEntry` to avoid
    // shadowing the `entry` module name used elsewhere in HarmonyOS tooling.
    let entry_ability = format!(
        "// Auto-generated by Perry — do not edit.\n\
         ...
         \x20\x20\x20\x20}}\n\
         \x20\x20\x20\x20onWindowStageDestroy() {{}}\n\
    ...
    let index_page = "// Auto-generated by Perry — do not edit.\n\
        @Entry\n\
        @Component\n\
        struct Index {\n\
        \x20\x20\x20\x20build() {\n\
        \x20\x20\x20\x20\x20\x20\x20\x20Column() {\n\
        \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20Text('Perry app running')\n\
        \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20.fontSize(20)\n\
    ...
    fs::write(pages_dir.join("Index.ets"), index_page)?;
