...
// =============================================================================
// JS interop stubs — generated by new codegen but only functional with --enable-js-runtime
// =============================================================================

#[no_mangle]
pub extern "C" fn js_create_callback(_func: f64, _arg_count: i64) -> f64 { 0.0 }

#[no_mangle]
pub extern "C" fn js_call_function(_module: i64, _name: i64, _args: i64, _argc: i64) -> f64 { 0.0 }

#[no_mangle]
pub extern "C" fn js_await_js_promise(_value: f64) -> f64 { 0.0 }

#[no_mangle]
pub extern "C" fn js_load_module(_path: i64) -> i64 { 0 }

#[no_mangle]
pub extern "C" fn js_new_from_handle(_handle: f64, _args: i64, _argc: i64) -> f64 { 0.0 }

#[no_mangle]
pub extern "C" fn js_new_instance(_module: i64, _class: i64, _args: i64, _argc: i64) -> f64 { 0.0 }
...
#[no_mangle]
pub extern "C" fn js_get_export(_module: i64, _name: i64) -> f64 { 0.0 }
