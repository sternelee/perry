...
// Tier 2.2 (v0.5.333): the inline `style: { ... }` destructure family
// (apply_inline_style + 7 internal helpers, ~510 LOC) moved to a
// `lower_call/` sub-module. Same pattern as Tier 2.1's compile.rs split.
mod ui_styling;
